...
public class mServiceList {
    ...
    public static final String Base_URL = "https://shyamsteel.tech:8002/"; //AWS Server
    ...
    public static final String attendance_leave_approval_list = "attendance_leave_approval_list/?";
    ...
    public static final String attendance_admin_daily_list = "attendance_admin_daily_list/?";
    ...
    public static final String post_login = "login_new/";
